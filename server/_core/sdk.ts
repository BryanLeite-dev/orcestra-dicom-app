  ...
  async authenticateRequest(req: Request): Promise<User> {
    ...
    if (authHeader && authHeader.startsWith("Bearer ")) {
      ...
      try {
        ...
        console.log("[Auth] JWT token received, userId:", userId);
        ...
        if (userId) {
          ...
          if (database) {
            ...
            if (foundUsers && foundUsers.length > 0) {
              console.log("[Auth] ✅ User authenticated via JWT:", foundUsers[0].email, "Role:", foundUsers[0].role);
              return foundUsers[0];
            }
          }
        }
      } catch (error) {
        console.log("[Auth] JWT verification failed, falling back to cookies. Error:", (error as any)?.message);
      }
    }
    ...
    console.log("[Auth] Attempting cookie-based auth - Cookie found:", !!sessionCookie);
    ...
    console.log("[Auth] ✅ User authenticated via cookie:", user.email, "Role:", user.role);
